...
import com.workintech.s19d2.service.AuthenticationServiceImpl;
...
public class AuthController {
    ...
    public RegisterResponse register(@RequestBody RegistrationMember registrationMember) {
        ...
        return new RegisterResponse(createdMember.getEmail(), " Kayıt başarılı bir şekilde oluşturuldu.");
    }
